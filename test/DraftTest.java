...
class DraftTest
{
    ...
    void testToByteArrayAndForth()
    {
        ...
        Draft draftA = new Draft(Draft.DraftType.HEARTBEAT, (byte) 10, (byte) 20, 12, 25, 20, 20, raftEntryArray);
    ...
    {
        Draft draftA = new Draft(Draft.DraftType.HEARTBEAT, (byte) 10, (byte) 20,12, 10, 10, 10, new RaftEntry[0]);
        Draft draftB = new Draft(Draft.DraftType.HEARTBEAT, (byte) 10, (byte) 20, 12, 10, 10, 10, new RaftEntry[0]);
        assertTrue(draftA.isEquivalentTo(draftB));
        assertTrue(draftB.isEquivalentTo(draftA));

        Draft draftC = new Draft(Draft.DraftType.REQUEST_VOTE, (byte) 10, (byte) 20,12, 10, 10, 10, new RaftEntry[0]);
